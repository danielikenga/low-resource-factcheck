...
PREDICTIONS_PATH = "results/llm/qwen_claim_only_predictions.csv"
...
Your task is to classify the claim into exactly one of these labels:
- supports
- refutes
- nei

Definitions:
supports = the claim is supported by available knowledge.
refutes = the claim is contradicted by available knowledge.
