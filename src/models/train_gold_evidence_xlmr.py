...
RESULTS_PATH = "results/gold_evidence/xlmr_gold_evidence_results.json"
PREDICTIONS_PATH = "results/gold_evidence/xlmr_gold_evidence_predictions.csv"
...
def main():
    ...
    training_args = TrainingArguments(
        output_dir="outputs/xlmr_gold_evidence",
        eval_strategy="epoch",
        save_strategy="no",
        learning_rate=2e-5,
