...
RESULTS_PATH = "results/baselines/xlmr_custom_split_results.json"
PREDICTIONS_PATH = "results/baselines/xlmr_custom_split_predictions.csv"
...
def main():
    ...
    training_args = TrainingArguments(
        output_dir="outputs/xlmr_custom_split",
        eval_strategy="epoch",
        save_strategy="no",
        learning_rate=2e-5,
